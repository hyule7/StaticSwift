...
## Scope
Chases anyone who opened the order form or started a brief and did not finish, with a one-line nudge and the free-preview offer. Abandoned briefs are money left on the table.

## Allowed tools
get-clients, queue-submit. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- One specific question restarts a stalled brief faster than a paragraph.
