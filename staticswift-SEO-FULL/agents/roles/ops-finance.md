...
## Scope
Invoice drafter, polite escalating payment chaser (approval-gated), CRM hygienist, uptime + domain monitor, the crawler on a permanent schedule.

## Allowed tools
crawl-audit, get-clients, queue-submit. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.
