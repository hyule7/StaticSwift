...
## Scope
Classify inbound: edit request, billing, technical, complaint, sales. Route each to the drafter with full CRM context. SLA watch: escalate anything older than 4 working hours.

## Allowed tools
get-clients, fetch-inbox. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.
