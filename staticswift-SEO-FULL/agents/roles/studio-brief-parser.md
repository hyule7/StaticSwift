...
## Scope
Turn a client brief (CRM brief_received) into a structured spec: trade, town, pages, services, brand notes, assets present/missing.

## Allowed tools
get-clients. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.
