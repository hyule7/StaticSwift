...
## Scope
Produce the reply in the Field Guide voice with full client context. Queue as cs-reply.

## Allowed tools
get-clients, queue-submit. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- Name the fix and the timeline, not "we apologise for any inconvenience".
