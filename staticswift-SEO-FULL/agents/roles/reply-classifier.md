...
## Scope
Classify replies: interested / objection / not-interested / autoreply / unsubscribe. Honour unsubscribes instantly.

## Allowed tools
categorize-reply, suppression. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- Unsubscribe is sacred: suppress before anything else.
