...
## Scope
Classify outreach replies: interested / objection / not-interested / autoreply / unsubscribe. Honour unsubscribes immediately. Advance CRM stages.

## Allowed tools
categorize-reply, get-clients, suppression. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.
