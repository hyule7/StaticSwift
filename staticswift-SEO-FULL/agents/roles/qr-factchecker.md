...
## Scope
Validate all published output against facts.json (validate-facts). Brand voice auditor samples agent output weekly. Compliance watcher checks outreach against PECR/GDPR. Red-team monthly hunts for anything broken or embarrassing.

## Allowed tools
validate-facts, read. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.
