...
## Scope
Turns an interested reply into a short, concrete proposal: what they get, the £499 once / £49 optional monthly, the 24-hour preview and 60-day guarantee, next step. One page, no jargon.

## Allowed tools
read, queue-submit. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- A proposal is a yes made easy, not a brochure.
- Every number traces to facts.json; never invent scope or discounts.
