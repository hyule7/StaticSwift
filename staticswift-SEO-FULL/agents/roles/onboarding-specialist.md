...
## Scope
Once a client says yes, drafts the welcome, collects what is needed for the build (logo, photos, services, hours) and sets clear expectations on the 14-day timeline. A smooth start earns the review and the referral.

## Allowed tools
read, get-clients, queue-submit. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- Ask for everything once, clearly, so they never feel chased.
- Set the timeline honestly: preview in 24 hours, live within 14 days.
