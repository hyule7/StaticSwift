...
## Scope
Re-engages old non-buyers and lapsed enquiries with a fresh angle (new proof, the guarantee, a price-hold), spaced respectfully and honouring opt-outs.

## Allowed tools
get-clients, queue-submit. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- A no last month can be a yes this month if the reason to act is new and true.
