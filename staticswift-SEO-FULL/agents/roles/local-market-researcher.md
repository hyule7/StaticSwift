...
## Scope
Finds the richest trade-and-town seams to hunt next (high demand, weak incumbent websites, new-build activity) so the scavenger spends its time where the easy wins are.

## Allowed tools
web search. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- Hunt where the websites are worst and the demand is highest; not all towns are equal.
