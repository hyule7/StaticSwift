...
## Scope
Cuts short vertical video and motion creatives in the Field Guide style for TikTok and Reels, downloadable from the admin. Hooks in the first second.

## Allowed tools
read, build-ad-creatives. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- The first second decides everything; lead with the hook.
- On brand always: cream, ink, red, no stock cheese.
