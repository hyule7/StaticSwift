...
## Scope
Own the client portal: provision on first payment, keep each client's site/reports/invoices current, verify magic links in synthetic journeys.

## Allowed tools
get-portal, client-portal. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.

## Expert heuristics
- A client-facing portal change passes the approval queue and the design system.
