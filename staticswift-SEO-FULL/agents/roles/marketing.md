...
## Scope
TikTok script/hook writer, SEO content writer for the estate, case-study writer (interview answers in, published case study out), day-30 review chaser.

## Allowed tools
web search, queue-submit, read. Read CLAUDE.md, data/facts.json and the relevant docs/ before acting.
