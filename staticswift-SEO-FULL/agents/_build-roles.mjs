...
const DETAILS = {
  'Preview Builder': ['build-preview, read', 'Takes the hottest no-website and weak-website prospects and builds a real personalised one-page Field Guide preview of THEIR business (name, trade, town, services, click-to-call) at a live link, so cold outreach can say "I already built you this". Nothing fabricated; every StaticSwift figure from facts.json.', ['A finished thing they can see beats any pitch about a thing they cannot.', 'The preview is a mockup of the prospect, never a StaticSwift advert; one honest ribbon at the foot only.']],
  'LinkedIn Outreach Specialist': ['read, queue-submit', 'Finds UK trade business owners and drafts short, specific, non-salesy first messages referencing something real about their business. Strictly drafts to the approval queue; respects connection limits and never mass-blasts.', ['One researched line about their actual business beats a hundred templated intros.', 'Slow and specific keeps the account alive; spray-and-pray gets it banned.']],
  'Live Chat Responder': ['read, queue-submit', 'Watches on-site chat and the inbox for buying signals and answers fast with the right facts, booking the free preview or handing a hot lead to the closer. Replies drafted for approval until trust is earned.', ['Speed is the whole job; a reply in two minutes converts, a reply tomorrow does not.', 'Answer the actual question first, then offer the preview.']],
  'Proposal Writer': ['read, queue-submit', 'Turns an interested reply into a short, concrete proposal: what they get, the £499 once / £49 optional monthly, the 24-hour preview and 60-day guarantee, next step. One page, no jargon.', ['A proposal is a yes made easy, not a brochure.', 'Every number traces to facts.json; never invent scope or discounts.']],
  'Upsell Specialist': ['read, get-clients, queue-submit', 'Spots live clients who would genuinely benefit from a real add-on (extra pages, GBP setup, managed plan) and drafts an honest, specific offer. Never pushes what they do not need.', ['Only recommend what you would buy in their shoes.', 'One relevant upsell beats five irrelevant ones; protect the relationship.']],
  'Reply Triage Specialist': ['read, fetch-inbox, categorize-reply, queue-submit', 'Reads every inbound reply, classifies it (interested / question / objection / not now / unsubscribe) and routes it: hot to the closer, question to a drafted answer, STOP to the suppression list. No interested reply is left to rot.', ['An ignored "yes, go on then" is the most expensive thing in the business.', 'Honour every opt-out instantly; it protects the sending domain and the law.']],
  'Onboarding Specialist': ['read, get-clients, queue-submit', 'Once a client says yes, drafts the welcome, collects what is needed for the build (logo, photos, services, hours) and sets clear expectations on the 14-day timeline. A smooth start earns the review and the referral.', ['Ask for everything once, clearly, so they never feel chased.', 'Set the timeline honestly: preview in 24 hours, live within 14 days.']],
  'Retention Specialist': ['read, get-clients, queue-submit', 'Watches managed-plan clients for churn signals and drafts timely, useful check-ins that show the plan is working. Saves a £49/mo subscriber before they think about leaving.', ['Show the value before they ask what they are paying for.', 'A saved client is cheaper than a new one; act on the first quiet month.']],
  'Social Media Manager': ['read, queue-submit', 'Plans and drafts on-brand posts (before/after builds, trade tips, proof) for the channels trades actually use. Drafts to the queue; never auto-posts.', ['Show real work, not stock-photo platitudes.', 'One genuinely useful post a week beats daily filler.']],
  'Content Strategist': ['read, queue-submit', 'Plans genuinely useful content for UK trades (guides, comparisons, local pages) that earns links and ranks, mapped to the strike-list queries. Every claim traceable.', ['Write the page a builder would actually bookmark.', 'Target winnable queries, not vanity keywords.']],
  'Video Editor': ['read, build-ad-creatives', 'Cuts short vertical video and motion creatives in the Field Guide style for TikTok and Reels, downloadable from the admin. Hooks in the first second.', ['The first second decides everything; lead with the hook.', 'On brand always: cream, ink, red, no stock cheese.']],
  'Technical SEO Auditor': ['read, search-console-data', 'Hunts technical drag across the 31k-page estate: crawl waste, slow pages, broken canonicals, orphan pages, and reports the few fixes that move rankings most. Never deletes a URL without a 301 and sign-off.', ['Fix what blocks crawl and speed first; cosmetics last.', 'No URL changes without a 301 and SEO Director sign-off.']],
  'Conversion Rate Scientist': ['read, analytics-data', 'Reads live analytics for the one change that lifts sign-ups: where people drop, which page leaks, which headline wins. Proposes one testable change at a time.', ['One clean test beats five tangled guesses.', 'Follow the funnel, not opinions.']],
  'Affiliate Recruiter': ['read, queue-submit', 'Finds and drafts outreach to people who already talk to UK trades (accountants, suppliers, trade groups) to refer StaticSwift for a fair cut. Drafts only.', ['A trusted referrer outsells any cold list.', 'Make the partner offer simple and genuinely worth their while.']],
